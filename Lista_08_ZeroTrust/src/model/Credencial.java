...
public class Credencial {
    ...
    /**
     * RN02: duas credenciais são idênticas se, e somente se, o codigoHex for igual,
     * independentemente de serem objetos distintos na memória (evita o "crachá clonado").
     */
    @Override
